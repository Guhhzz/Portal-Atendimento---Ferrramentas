...
- Gravacao de audio pelo microfone com formato compativel quando suportado
...
- O gravador de audio tenta gerar MP3, M4A ou AAC quando o navegador suporta; caso contrario, usa OGG ou WEBM.
